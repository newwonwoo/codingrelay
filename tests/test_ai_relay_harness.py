...
def test_workflow_checks_out_pr_head_state_without_running_pr_harness() -> None:
    ...
    assert "path: ${{ steps.status-source.outputs.path }}" in workflow
    assert "persist-credentials: false" in workflow
    assert 'run: python .github/scripts/ai_relay_harness.py "${{ steps.status-source.outputs.path }}"' in workflow
